...
// SGS - Add support for more point styles
inline void TriangleUpFFromCenterF(const PointF pntCenterF, float fWidth, float fHeight, std::vector<PointF>& pntVec)
{
    // Triangle - Point Up
    PointF pnt(pntCenterF.X, pntCenterF.Y - fHeight / 2.0f);
    pntVec.push_back(pnt);
    pnt.X = pntCenterF.X + fWidth / 2.0f;
    pnt.Y = pntCenterF.Y + fHeight / 2.0f;
    pntVec.push_back(pnt);
    pnt.X = pntCenterF.X - fWidth / 2.0f;
    pnt.Y = pntCenterF.Y + fHeight / 2.0f;
    pntVec.push_back(pnt);
...
inline void TriangleDownFFromCenterF(const PointF pntCenterF, float fWidth, float fHeight, std::vector<PointF> &pntVec)
{
    // Triangle - Point Down
    PointF pnt(pntCenterF.X, pntCenterF.Y + fHeight / 2.0f);
    pntVec.push_back(pnt);
...
inline void DiamondFFromCenterF(const PointF pntCenterF, float fWidth, float fHeight, std::vector<PointF>& pntVec)
{
    // Diamond
    PointF pnt(pntCenterF.X, pntCenterF.Y - fHeight / 2.0f);
    pntVec.push_back(pnt);
